...
## The url path for the application.
#  Default: '/lab'
c.JupyterNotebookApp.app_url = '/me/${openPort}/tree'
...
#  Default: '/tree'
c.JupyterNotebookApp.default_url = '/me/${openPort}/tree'
...
## Url where the static assets for the extension are served.
#  See also: ExtensionApp.static_url_prefix
c.JupyterNotebookApp.static_url_prefix = '/me/${openPort}/static'
