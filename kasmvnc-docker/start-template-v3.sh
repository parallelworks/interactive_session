...
default_mount_directories="/p/home /p/work /p/work1 /p/app /p/cwfs /scratch /run/munge /etc/pbs.conf /var/spool/pbs /opt/pbs"
...
# Build "-v dir:dir" flags for directories that exist. With warn_missing="warn" a
