...
This workflow starts an interactive session for [FSL](https://fsl.fmrib.ox.ac.uk/fsl/fslwiki/FSL) in a desktop environment. The services are started in the selected slurm partition using an sbatch command.
