## NextFlow Interactive Session
This workflow starts an interactive session for NextFlow in a desktop environment. The services are started in the selected slurm partition using an sbatch command.
