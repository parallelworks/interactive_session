...
This workflow starts an interactive session for Matlab in a desktop environment. The services are started in the selected slurm partition using an sbatch command.
