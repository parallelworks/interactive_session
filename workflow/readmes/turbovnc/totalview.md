## TotalView Interactive Session

This workflow starts an interactive session for TotalView in a desktop environment. The services are started in the selected slurm partition using an sbatch command.
